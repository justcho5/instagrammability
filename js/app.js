...
//     scale = ctx.canvas.clientWidth/500;
//     if (!e)
//         var e = event;
//
//     if (e.offsetX) {
...
function loadBackground(element){
    ...
    database.collection("images").doc("0").get().then(function(doc){
      ...
      element.src = "data/test/"+remainingImages[0];
...
function writeInOutUserData(imageId, indoor, outdoor, database) {
...
// only change pictures when indoor or outdoor is clicked
    ...
    console.log(imageId)
    writeInOutUserData(imageId, indoor, outdoor, database);
...
function init(database) {
    ...
    loadBackground(document.getElementById("background"));
